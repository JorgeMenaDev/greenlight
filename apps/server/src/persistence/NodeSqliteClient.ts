...
export const TypeId: TypeId = "~greenlight/sqlite-node/SqliteClient";

export type TypeId = "~greenlight/sqlite-node/SqliteClient";

/**
 * SqliteClient - Effect service tag for the sqlite SQL client.
 */
export const SqliteClient = Context.Service<Client.SqlClient>(
  "greenlight/persistence/NodeSqliteClient",
);
