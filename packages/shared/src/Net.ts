/**
 * Net - Startup networking helpers (port availability and reservation).
 *
 * Ported from t3code's packages/shared/src/Net.ts.
 *
 * @module Net
 */
...
export class NetService extends Context.Service<NetService, NetServiceShape>()(
  "@greenlight/shared/Net/NetService",
) {}

export const make = (): NetServiceShape => {
  /**
